...
from app.semantic.lora import LoRASemanticAdapter
from app.semantic.cross_site import CrossSiteAnalyzer


@pytest.fixture(autouse=True)
def mock_embeddings():
    import app.semantic.embeddings as emb
    emb._model = None
    with patch("app.semantic.embeddings._get_model") as mock_get:
